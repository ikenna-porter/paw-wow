...
class ConnectionManager:
    ...
    async def connect(self, socket_dict):
...
async def websocket_endpoint(
    websocket: WebSocket, conversation_id: int, repo: MessageRepository = Depends()
):

    socket_dict = {"websocket": websocket, "conversation_id": conversation_id}
